  ...
  return (
    <>
      ...
      {isLoading ? (
        ...
        <>
          <div className="flex scale-80 overflow-y-hidden flex-wrap relative items-between mt-[2rem] ml-[10rem]">
            <div>
              <img
                src={product.image}
                alt={product.name}
                ...
                {product.countInStock > 0 && (
                  <div>
                    <select
                      ...
                      className="p-2 w-[6rem] border-2 border-black  rounded-lg text-black"
                    >
            ...
            <div className="mt-[5rem] p-4 border-2 rounded-2xl container flex flex-wrap items-start justify-between ml-[10rem]">
              <ProductTabs
